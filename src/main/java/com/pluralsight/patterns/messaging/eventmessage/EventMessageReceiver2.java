 ...
 */
@Component
public class EventMessageReceiver2 {

   private static final Log log = LogFactory.getLog(EventMessageReceiver2.class);

   @Autowired
   private ConnectionFactory rabbitMqConnectionFactory;

   private static final String QUEUE_NAME = "InsurerA.LowGlucoseEpisode";
      ...
      try {
         ...
         Consumer consumer = new DefaultConsumer(channel) {
            ...
            public void handleDelivery(String consumerTag, Envelope envelope,
               ...
               System.out.println("Receiver 2: " + new String(body));
            }
         };
